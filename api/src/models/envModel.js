...
export const envGet = () => {
    ...
    const { DB_USER, DB_NAME, SERVER_EMAIL, USER_EMAIL, TIME_ZONE, DATE_FORMAT } = envObject;
    return { DB_USER, DB_NAME, SERVER_EMAIL, USER_EMAIL, TIME_ZONE, DATE_FORMAT };
};
...
DB_NAME=${data.dbName}
DB_URI=postgresql://${data.dbUser}:${data.dbPass}@localhost:5432
