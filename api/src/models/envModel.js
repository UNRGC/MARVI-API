...
export const envGet = () => {
    ...
    const { DB_USER, DB_NAME, DB_SERVER, ONLINE, SERVER_EMAIL, USER_EMAIL, TIME_ZONE, DATE_FORMAT } = envObject;
    return { DB_USER, DB_NAME, DB_SERVER, ONLINE, SERVER_EMAIL, USER_EMAIL, TIME_ZONE, DATE_FORMAT };
};
