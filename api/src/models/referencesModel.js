...
export const getUnit = async (unidad) => {
    ...
    const response = await client.query("SELECT * FROM consultar_unidad($1);", [unidad]);
...
export const getUnits = async () => {
    ...
    const response = await client.query("SELECT * FROM vst_unidades;");
...
export const getFrequency = async (frecuencia) => {
    ...
    const response = await client.query("SELECT * FROM consultar_frecuencia_compra($1);", [frecuencia]);
...
export const getFrequencies = async () => {
    ...
    const response = await client.query("SELECT * FROM vst_frecuencia_compras;");
