...
import { getClientByEmail } from "../models/clientsModel.js";
import { loginClient, resetPasswordClient } from "../models/loginClientsModel.js";
...
export const loginClientHandler = async (req, res) => {
    try {
        ...
        clientResponse.rows[0].fecha_registro = formattedDateFechaRegistro;
...
// Controlador para pagina de restablecimiento de contraseña
