...
export const getService = async (codigo) => {
    ...
    // Retornar
    return await client.query("SELECT * FROM consultar_servicio($1);", [codigo]);
};
...
export const getServices = async (data) => {
    ...
    // Retornar
    return await client.query("SELECT * FROM filtrar_servicios($1, $2, $3::INT, $4::INT);", [data.columna_orden, data.orden, data.limit, data.offset]);
};
...
export const searchServices = async (data) => {
    ...
    // Retornar
    return await client.query("SELECT * FROM buscar_servicios($1, $2::INT, $3::INT);", [data.busqueda, data.limit, data.offset]);
};
