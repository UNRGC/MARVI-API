...
export const getUser = async (usuario) => {
    ...
    // Retornar
    return await client.query("SELECT * FROM consultar_usuario($1);", [usuario]);
};
...
export const getUsers = async (data) => {
    // Obtener un usuario de la base de datos
    // Retornar
    return await client.query("SELECT * FROM filtrar_usuarios($1, $2, $3::INT, $4::INT);", [data.columna_orden, data.orden, data.limit, data.offset]);
};
...
export const getActiveUsers = async () => {
    // Obtener un usuario de la base de datos
    // Retornar
    return await client.query("SELECT * FROM vst_usuarios_logueados;");
};
...
export const searchUsers = async (data) => {
    ...
    // Retornar
    return await client.query("SELECT * FROM buscar_usuarios($1, $2::INT, $3::INT)", [data.busqueda, data.limit, data.offset]);
};
